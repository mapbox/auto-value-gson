...
import static com.mapbox.auto.value.gson.AutoValueGsonExtension.USE_FIELD_NAME_POLICY;
...
public class AutoValueGsonExtension extends AutoValueExtension {
  ...
  public static final String GENERATED_COMMENTS = "https://github.com/mapbox/auto-value-gson";
  ...
  public String generateClass(Context context, String className, String classToExtend, boolean isFinal) {
    ...
    GsonTypeAdapterConfig gsonTypeAdapterConfig = type.getAnnotation(GsonTypeAdapterConfig.class);
    boolean useBuilderOnRead = gsonTypeAdapterConfig != null ? gsonTypeAdapterConfig.useBuilderOnRead() : GsonTypeAdapterConfig.USE_BUILDER_ON_READ_DEFAULT;
  ...
  private TypeSpec createTypeAdapter(
    ...
    if (useFieldNamePolicy) {
      constructor.addStatement("this.realFieldNames = $T.renameFields($T.class, fields, gson.fieldNamingStrategy())",
          ClassName.get("com.mapbox.auto.value.gson.internal", "Util"),
          superClassType);
    }
